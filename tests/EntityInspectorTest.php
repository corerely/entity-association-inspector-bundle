...
class EntityInspectorTest extends KernelTestCase
{
    ...
    public function testDeleteOneToManyWithEnabledCascadeRemove(): void
    {
        ...
        $this->assertTrue($inspector->isSafeDelete($product->_real()));
    }
    ...
    public function testDeleteOneToManyWithNoCascadeRemove(): void
    {
        ...
        $this->assertFalse($inspector->isSafeDelete($category1->_real()));
        // But can delete category without relation
        $this->assertTrue($inspector->isSafeDelete($category2->_real()));
    }
    ...
    public function testDeleteOneToOneInverseSide(): void
    {
        ...
        $this->assertFalse($inspector->isSafeDelete($owner1->_real()));
        $this->assertTrue($inspector->isSafeDelete($owner2->_real()));
    }
    ...
    public function testDeleteManyToManyInverseSide(): void
    {
        ...
        $this->assertFalse($inspector->isSafeDelete($tag1->_real()));
        $this->assertFalse($inspector->isSafeDelete($tag2->_real()));
        $this->assertTrue($inspector->isSafeDelete($tag3->_real()));
    }
